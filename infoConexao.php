...
<script>
    ...
    function onClickAdicionarTabela() {
    ...
    function getDivAdicionarTabela(count) {
        const div = document.createElement('div');
        div.className = 'col';

        const input = document.createElement('input');
        input.className = "btn btn-success mt-5";
        input.setAttribute('value', 'Adicionar Tabela');
        input.setAttribute('onClick', 'onClickAdicionarTabela()');
        div.append(input);
        return div;
    }
    ...
    function getDivTabelaNome(count) {
        ...
        label.innerText = 'Nome da Tabela';

        const input = document.createElement('input');
        input.className = 'form-control';
        input.setAttribute('required', 'true');
        input.setAttribute('type', 'text');
        input.setAttribute('placeholder', 'Insira o nome da Tabela');
        input.setAttribute('name', 'nomeTabela'+count);
